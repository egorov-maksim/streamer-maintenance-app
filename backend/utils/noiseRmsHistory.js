 ...
 *
 * @param {Array<{ id: number, uploadedAt: string, label: string|null }>} uploads - oldest first
 ...
 * @returns {{ uploads: Array<{ id: number, uploadedAt: string, label: string|null }>, streamers: Array<{ streamerId: number, avgRms: Array<number|null> }> }}
 */
